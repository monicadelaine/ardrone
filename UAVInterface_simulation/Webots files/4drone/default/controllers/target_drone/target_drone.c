...
if ((coords[0] < -19) && (x_move_switch_left =! 0))
{ 
//printf("Switch activated\n");
rot[3] = fmod(rand(),(2*pi));
...
if ((coords[2] < -19) && (y_move_switch =! 0))
{ // y border
//printf("Switch activated\n");
rot[3] = fmod(rand(),(2*pi));
y_move_switch = 0;
...
if ((coords[2] > 11) && (y_move_switch_left =! 0))
{
//printf("Switch activated\n");
rot[3] = fmod(rand(),(2*pi));
...
// socket //
 ...
 //data_pack1 = malloc(size * sizeof(char));
  ...
  do {
      ...
      //receiveInfo();
      //goToPos();
      //randomFlight(); // comment out random flight 
       //mainUdp();
