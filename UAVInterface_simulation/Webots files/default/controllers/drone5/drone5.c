...
#define REMOTE_SERVER_PORT 1514 //video
#define REMOTE_SERVER_PORT_WP 1515 //rec wp
#define REMOTE_SERVER_PORT2 1501
#define REMOTE_SERVER_PORT3 1516 // send wp
            ...
            case 0:
              ...
              // printf("Drone 2 Waiting\n");
               ...
               // printf("Got packet\n");
                ...
                //printf("wp[4]: %f\nwp[7]: %f\n",wp_info[4],wp_info[5]);
                if ((wp_info[0] == 4.000) && (wp_info[3] != curr_wp) &&(wp_info[x_i+1] != 0.0) && (wp_info[x_i+2] != 0.0)){
...
// socket //
  ...
  //pthread_create(&vid,NULL,video,"Data stuff.. \n");
    ...
    drone_node = wb_supervisor_node_get_from_def("Drone5");
