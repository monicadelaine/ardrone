...
%  plotcamera, plotpoints, getRangeOverlap
% 
...
%while targetFound == 0
    ...
    totalChoices = 48; %numChoices*numChoices;  
        ...
        for i = 1:numChoices
            for j = numChoices+1:numChoices*2
                for k = numChoices*2+1:numChoices*3 %%
                    ...
                    maxALUL_Pos(alulCnt,:) = [allChoices(i,1) allChoices(j,1) allChoices(k,1)]
                    alulCnt = alulCnt + 1;
                    maxALUL
                    prevALUL
    ...
    cell_pos = [num2str(xc(1,1)) ',' num2str(MAX_Y-yc(1,1)) ',' num2str(xc(2,1)) ',' num2str(MAX_Y-yc(2,1)) ','  num2str(xc(3,1)) ',' num2str(MAX_Y-yc(3,1)) ',' num2str(t)]
