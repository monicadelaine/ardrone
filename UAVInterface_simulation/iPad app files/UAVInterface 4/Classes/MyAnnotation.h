...
@interface MyAnnotation3 : NSObject <MKAnnotation>
{
    CLLocationCoordinate2D _coordinate;
    NSNumber *latitude;
    NSNumber *longitude;
...
@interface MyAnnotation5 : NSObject <MKAnnotation>
{
    CLLocationCoordinate2D _coordinate;
    NSNumber *latitude;
    NSNumber *longitude;
...
@interface MyAnnotation4 : NSObject <MKAnnotation>
{
    CLLocationCoordinate2D _coordinate;
    NSNumber *latitude;
    NSNumber *longitude;
...
@interface MyAnnotation6 : NSObject <MKAnnotation>
{
    CLLocationCoordinate2D _coordinate;
    NSNumber *latitude;
    NSNumber *longitude;
